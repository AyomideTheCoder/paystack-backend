...
class ThreadsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      length: 2,
      initialIndex: 1, // Start on Replies tab
      child: Scaffold(
        appBar: AppBar(
          leading: IconButton(
          ...
          actions: const [
            Padding(
              ...
              child: Row(
                children: [
                  Icon(Icons.network_cell, color: Colors.grey, size: 16),
                  SizedBox(width: 5),
                  Text('10:18 AM', style: TextStyle(color: Colors.grey, fontSize: 12)),
                ],
              ),
            ),
          ],
        ...
        body: TabBarView(
          children: [
            Container(), // Placeholder for Threads Tab
            ListView(
              ...
              children: [
                ...
                Image.network(
                  'https://via.placeholder.com/300x200', // Replace with sunset image
                  fit: BoxFit.cover,
